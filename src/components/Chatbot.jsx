...
const Chatbot = () => {
  ...
  const [messages, setMessages] = useState([
    {
      id: 1,
      type: 'bot',
      message: 'Hello! I\'m your AgriTech assistant. How can I help you today?',
  ...
  const botResponses = {
    'hello': 'Hello! Welcome to AgriTech. I\'m here to help you with all your smart farming questions.',
          ...
          >
            ...
            <div className="bg-primary-600 text-white p-4 flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h3 className="font-semibold">AgriTech Assistant</h3>
