...
const Home = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      description: "24/7 agricultural expert guidance in Indiai"
    }
  ];
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white max-w-4xl mx-auto px-4">
          ...
          >
            ...
            <button className="flex items-center space-x-2 text-white border-2 border-white px-6 py-3 rounded-lg hover:bg-white hover:text-gray-900 transition-colors duration-200">
      ...
      <section className="bg-primary-600 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-primary-100 mb-8 max-w-2xl mx-auto">
            Join thousands of India farmers who are already saving money and increasing yields
          </p>
          <Link
            to="/roi-calculator"
